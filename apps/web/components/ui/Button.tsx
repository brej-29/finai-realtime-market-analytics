...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        primary:
          "bg-gradient-to-b from-brand-light/90 to-brand text-slate-950 shadow-soft hover:shadow-glow",
        secondary:
          "border border-white/10 bg-surface text-foreground hover:border-white/20 hover:bg-surface-hover",
